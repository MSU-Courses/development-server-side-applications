...
- [Обработка ошибок. Валидация. Логгирование](#обработка-ошибок-валидация-логгирование)
  - [Содержание](#содержание)
  - [Введение](#введение)
  - [Ошибки и исключения в Node.js](#ошибки-и-исключения-в-nodejs)
  - [Типы ошибок](#типы-ошибок)
    - [Операционные ошибки (Operational Errors)](#операционные-ошибки-operational-errors)
    - [Программные ошибки (Programming Errors)](#программные-ошибки-programming-errors)
    - [Разделение ошибок на уровне кода](#разделение-ошибок-на-уровне-кода)
  - [Собственные классы ошибок](#собственные-классы-ошибок)
    - [Основы создания пользовательских ошибок](#основы-создания-пользовательских-ошибок)
    - [Специализированные классы ошибок](#специализированные-классы-ошибок)
  - [Глобальный обработчик ошибок](#глобальный-обработчик-ошибок)
    - [Создание глобального обработчика](#создание-глобального-обработчика)
    - [Регистрация глобального обработчика](#регистрация-глобального-обработчика)
  - [Асинхронная обработка ошибок](#асинхронная-обработка-ошибок)
  - [Валидация данных](#валидация-данных)
    - [Ручная валидация](#ручная-валидация)
    - [Валидация с express-validator](#валидация-с-express-validator)
    - [Другие библиотеки валидации](#другие-библиотеки-валидации)
  - [Логирование](#логирование)
    - [Ручное логирование](#ручное-логирование)
    - [Использование Winston для логирования](#использование-winston-для-логирования)
    - [Уровни логирования](#уровни-логирования)
    - [Логирование с контекстом запроса](#логирование-с-контекстом-запроса)
    - [Интеграция с внешними сервисами. Sentry](#интеграция-с-внешними-сервисами-sentry)
    - [Интеграция с внешними системами логирования](#интеграция-с-внешними-системами-логирования)
  - [Организация кода](#организация-кода)
  - [Дополнительно. Расширенная архитектура обработки ошибок](#дополнительно-расширенная-архитектура-обработки-ошибок)
    - [Паттерн с регистром обработчиков](#паттерн-с-регистром-обработчиков)
