...
- [Введение в Backend-разработку](#введение-в-backend-разработку)
  - [Содержание](#содержание)
  - [Что такое Backend и чем занимается Backend-разработчик?](#что-такое-backend-и-чем-занимается-backend-разработчик)
  - [Клиент-серверная архитектура веб-приложений](#клиент-серверная-архитектура-веб-приложений)
  - [Архитектуры веб-приложений](#архитектуры-веб-приложений)
    - [Монолитная архитектура](#монолитная-архитектура)
    - [Headless архитектура. Разделение фронтенда и бэкенда](#headless-архитектура-разделение-фронтенда-и-бэкенда)
    - [Сервисно-ориентированная архитектура (SOA)](#сервисно-ориентированная-архитектура-soa)
    - [Микросервисная архитектура](#микросервисная-архитектура)
  - [Взаимодействие фронтенда и бэкенда через API (REST)](#взаимодействие-фронтенда-и-бэкенда-через-api-rest)
  - [Использование Node.js для бэкенд-разработки](#использование-nodejs-для-бэкенд-разработки)
...
_Архитектура веб-приложения_ - это структура, которая определяет логическую и физическую организацию компонентов, их взаимодействие и методы связи для реализации веб-приложения.
...
Одним из решений данной проблемы стала _сервисно-ориентированная архитектура_. _Сервисно-ориентированная архитектура (Service Oriented Architecture, SOA)_ - это тип архитектуры, в котором приложение разбивается на независимые приложения, называемые _сервисами_, каждый из которых выполняет определенную функцию.
