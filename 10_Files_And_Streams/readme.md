...
- [Работа с файлами и потоками в Express.js](#работа-с-файлами-и-потоками-в-expressjs)
  - [Содержание](#содержание)
  - [Введение: Зачем нам файлы и потоки?](#введение-зачем-нам-файлы-и-потоки)
  - [Основы работы с файловой системой (fs module)](#основы-работы-с-файловой-системой-fs-module)
    - [Что такое fs module?](#что-такое-fs-module)
    - [Импорт fs модуля](#импорт-fs-модуля)
    - [Основные операции с файлами](#основные-операции-с-файлами)
    - [Синхронные vs Асинхронные операции](#синхронные-vs-асинхронные-операции)
  - [Введение в потоки данных (Streams)](#введение-в-потоки-данных-streams)
    - [Что такое потоки и зачем они нужны?](#что-такое-потоки-и-зачем-они-нужны)
    - [Пример использования потоков](#пример-использования-потоков)
  - [Типы потоков в Node.js](#типы-потоков-в-nodejs)
    - [Readable Streams (Потоки чтения)](#readable-streams-потоки-чтения)
    - [Writable (Поток записи)](#writable-поток-записи)
    - [Duplex (Двусторонний поток)](#duplex-двусторонний-поток)
    - [Transform (Преобразующий поток)](#transform-преобразующий-поток)
  - [Pipe: связывание потоков](#pipe-связывание-потоков)
    - [Что такое pipe?](#что-такое-pipe)
    - [Пример: копирование файла с использованием pipe](#пример-копирование-файла-с-использованием-pipe)
    - [Пример: сжатие файла](#пример-сжатие-файла)
  - [Обработка ошибок в потоках](#обработка-ошибок-в-потоках)
    - [Проблема обычного pipe](#проблема-обычного-pipe)
    - [Правильный способ: pipeline](#правильный-способ-pipeline)
    - [Добавление обработчиков ошибок к каждому потоку](#добавление-обработчиков-ошибок-к-каждому-потоку)
  - [Backpressure: управление потоком данных](#backpressure-управление-потоком-данных)
    - [Что такое backpressure?](#что-такое-backpressure)
    - [Проблема без управления backpressure](#проблема-без-управления-backpressure)
    - [Правильное управление backpressure](#правильное-управление-backpressure)
  - [Использование потоков с оператором for await of](#использование-потоков-с-оператором-for-await-of)
  - [Загрузка файлов в Express с помощью Multer](#загрузка-файлов-в-express-с-помощью-multer)
    - [Что такое Multer?](#что-такое-multer)
    - [Установка Multer](#установка-multer)
    - [Простой пример загрузки файла](#простой-пример-загрузки-файла)
    - [Валидация типов файлов](#валидация-типов-файлов)
    - [Параметр fileFilter](#параметр-filefilter)
    - [Получение загруженных файлов](#получение-загруженных-файлов)
  - [Безопасность при работе с файлами](#безопасность-при-работе-с-файлами)
    - [Основные угрозы](#основные-угрозы)
    - [Рекомендации по безопасности](#рекомендации-по-безопасности)
    - [Использование clamav для сканирования вирусов](#использование-clamav-для-сканирования-вирусов)
