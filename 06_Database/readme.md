...
- [Работа с базой данных в Express.js](#работа-с-базой-данных-в-expressjs)
  - [Содержание](#содержание)
  - [Зачем использовать базу данных в бэкенд-приложениях?](#зачем-использовать-базу-данных-в-бэкенд-приложениях)
  - [Установка и настройка PostgreSQL](#установка-и-настройка-postgresql)
    - [Ручная установка PostgreSQL (1). Установка на компьютер](#ручная-установка-postgresql-1-установка-на-компьютер)
      - [Linux](#linux)
      - [macOS](#macos)
      - [Windows](#windows)
    - [Ручная установка PostgreSQL (2). Настройка базы данных](#ручная-установка-postgresql-2-настройка-базы-данных)
      - [Создание пользователя](#создание-пользователя)
      - [Создание базы данных](#создание-базы-данных)
      - [Данные для подключения к базе данных](#данные-для-подключения-к-базе-данных)
    - [Установка PostgreSQL в Docker-контейнере](#установка-postgresql-в-docker-контейнере)
  - [Использование PostgreSQL в Express.js приложении](#использование-postgresql-в-expressjs-приложении)
    - [Установка и подключение к базе данных из Node.js (библиотека pg)](#установка-и-подключение-к-базе-данных-из-nodejs-библиотека-pg)
    - [Выполнение SQL-запросов из Express.js](#выполнение-sql-запросов-из-expressjs)
  - [Модель в MVC](#модель-в-mvc)
    - [Модель](#модель)
  - [Хорошие практики организации кода](#хорошие-практики-организации-кода)
  - [Использование MySQL/MariaDB: альтернатива PostgreSQL](#использование-mysqlmariadb-альтернатива-postgresql)
  - [Миграции базы данных](#миграции-базы-данных)
    - [Зачем нужны миграции?](#зачем-нужны-миграции)
    - [Как реализуются миграции?](#как-реализуются-миграции)
    - [Инструменты для миграций](#инструменты-для-миграций)
    - [Пример миграции с go-migrate](#пример-миграции-с-go-migrate)
