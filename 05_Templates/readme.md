...
- [Шаблонизация и шаблонизаторы. Обработка запросов](#шаблонизация-и-шаблонизаторы-обработка-запросов)
  - [Содержание](#содержание)
  - [Что такое шаблонизация и зачем нужны шаблонизаторы?](#что-такое-шаблонизация-и-зачем-нужны-шаблонизаторы)
  - [Использование шаблонов в Express](#использование-шаблонов-в-express)
    - [Подключение и настройка EJS в Express](#подключение-и-настройка-ejs-в-express)
    - [Вставка JavaScript-логики в шаблон](#вставка-javascript-логики-в-шаблон)
    - [Использование частичных шаблонов (partials)](#использование-частичных-шаблонов-partials)
  - [Отправка данных на сервер](#отправка-данных-на-сервер)
    - [Отправка и получение данных с помощью HTML-форм](#отправка-и-получение-данных-с-помощью-html-форм)
    - [Обработка данных в формате JSON](#обработка-данных-в-формате-json)
    - [Переадресация после обработки формы](#переадресация-после-обработки-формы)
...
<html lang="en">
  ...
  <body>
    <%- include('navbar', { links: [ { href: '/', text: 'Home' }, { href: '/about', text: 'About' }
    ] }) %>
    <h1><%= message %>!</h1>
  </body>
</html>
