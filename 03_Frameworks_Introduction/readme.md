# Архитектура MVC. Введение в фреймворки. Фреймворк Express.JS

## Содержание

- [Архитектура MVC. Введение в фреймворки. Фреймворк Express.JS](#архитектура-mvc-введение-в-фреймворки-фреймворк-expressjs)
  ...
  - [Архитектура MVC](#архитектура-mvc)
    ...
    - [Взаимодействие компонентов MVC](#взаимодействие-компонентов-mvc)
  - [Введение в фреймворки](#введение-в-фреймворки)
  - [Express: минималистичный фреймворк для Node.js](#express-минималистичный-фреймворк-для-nodejs)
    - [Установка и создание простого сервера на Express](#установка-и-создание-простого-сервера-на-express)
